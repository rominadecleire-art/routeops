...
SCANNED_PDF_PROMPT = (
    ...
    '- SIEMPRE incluí la localidad en cada dirección, aunque no haya código postal.\n'
    '  Si una fila no tiene localidad explícita, usá la localidad más repetida en la página o\n'
    '  la que aparezca en el encabezado de sección más cercano.\n'
